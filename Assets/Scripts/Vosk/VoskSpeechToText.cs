...
public class VoskSpeechToText : MonoBehaviour
{
	...
	public int MaxAlternatives = 200;
	...
	public void StartVoskStt(List<string> keyPhrases = null, string modelPath = default, bool startMicrophone = false, int maxAlternatives = 200)
	{
		if (_isInitializing)
		{
